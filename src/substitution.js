  ...
  function substitution(input, alphabet, encode = true) {
    ...
    if(encode === false||!encode){
      ...
      function decoder(macth){
        ...
        const correctLetterObj = alphabetObjsArr.find(((letterObj)=>letterObj.subChar.toLowerCase()===macth?true:false))
    ...
    function encoder(macth){
      ...
      const correctLetterObj = alphabetObjsArr.find(((letterObj)=>letterObj.letter.toLowerCase()===macth.toLowerCase()?true:false))
